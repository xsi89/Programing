...
'mySheets = Array("Volvo_Penta", "Volvo_3P")
 'strSheetName = Array("Volvo_3P")
'sstrSheetName= "Volvo_Business_Service")
'strSheetName = "Volvo_Group_Trucks_Technology"
'strSheetName = "Volvo_Information_Technology_AB"
'strSheetName = "Volvo_Group_Sweden"
'strSheetName = "Volvo_IT"
'strSheetname = "Volvo_Penta"
...
Dim ws As Worksheet, i As Integer
    ...
    sname = Array("Volvo_3P", "Volvo_Penta", "Volvo_Business_Service", "Volvo_Group_Trucks_Technology", "Volvo_Information_Technology_AB", "Volvo_Group_Sweden", "Volvo_IT")

    On Error Resume Next

    For i = 0 To UBound(sname)
    
         ActiveWorkbook.Sheets(sname(i)).Select
