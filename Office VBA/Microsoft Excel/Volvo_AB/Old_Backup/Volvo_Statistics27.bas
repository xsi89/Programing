    ...
    For r = 1 To m
        For s = 1 To n
            If Trim(ws1.Range("H" & r) & ws1.Range("I" & r)) = Trim(ws2.Range("A" & s) & ws2.Range("B" & s)) Then
                ...
                NoWorsdsTot = Round((NoNWords * NowordsS2), 2)
                FuzzyMatchTot = Round((FuzzyMatch * FuzzyMatchS2), 2)
                HundAndRepTot = Round((HundAndRep * HundAndRepS2), 2)
                'Total from all
                
                
                 myTot1 = NoWorsdsTot + FuzzyMatchTot + HundAndRepTot
                 
                 
                 
                 myTot2 = NoNWords + FuzzyMatch + HundAndRep * NowordsS2
                             
                MsgBox myTot2 - myTot1
